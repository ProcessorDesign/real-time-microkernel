#############################################################################
# Makefile for building: sterownik-plc
# Generated by qmake (3.0) (Qt 5.0.2) on: pt. lis 8 11:31:24 2013
# Project:  ../sterownik-plc/sterownik-plc.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ../sterownik-plc/sterownik-plc.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++-64 -I../sterownik-plc -I.
LINK          = g++
LFLAGS        = -m64
...
DIST          = /usr/share/qt5/mkspecs/features/spec_pre.prf \
		...
		../sterownik-plc/sterownik-plc.pro \
		../sterownik-plc/sterownik-plc.pro
QMAKE_TARGET  = sterownik-plc
DESTDIR       = 
TARGET        = sterownik-plc
...
Makefile: ../sterownik-plc/sterownik-plc.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/share/qt5/mkspecs/features/lex.prf \
		../sterownik-plc/sterownik-plc.pro
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ../sterownik-plc/sterownik-plc.pro
...
dist: 
	@test -d .tmp/sterownik-plc1.0.0 || mkdir -p .tmp/sterownik-plc1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/sterownik-plc1.0.0/ && (cd `dirname .tmp/sterownik-plc1.0.0` && $(TAR) sterownik-plc1.0.0.tar sterownik-plc1.0.0 && $(COMPRESS) sterownik-plc1.0.0.tar) && $(MOVE) `dirname .tmp/sterownik-plc1.0.0`/sterownik-plc1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/sterownik-plc1.0.0
...
main.o: ../sterownik-plc/main.c 
	$(CC) -c $(CFLAGS) $(INCPATH) -o main.o ../sterownik-plc/main.c
